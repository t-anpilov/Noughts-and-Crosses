...
function checkIt() {
	...
	if (rows[0].children[0] != '' && rows[0].children[0].innerHTML == rows[1].children[1].innerHTML && rows[0].children[0].innerHTML == rows[2].children[2].innerHTML) {
		{
	...
	/*if (rows[0].children[2] != '' && rows[0].children[2].innerHTML == rows[1].children[1].innerHTML && rows[0].children[2].innerHTML == rows[2].children[0].innerHTML) {
		{
